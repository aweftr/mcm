...
for i = 1:size_of_icycle_7
    ...
    if strcmp(icycle_7(i).type,'discharge')
        ...
        SOH_7 = [SOH_7, cur_SOH];
        cycle_times_SOH_7 = [cycle_times_SOH_7, cycle_7];
    end
    % 阻抗与循环次数
    if strcmp(icycle_7(i).type,'impedance')
        Re_resistance_7 = [Re_resistance_7, icycle_7(i).data.Re];
        Rct_resistance_7 = [Rct_resistance_7, icycle_7(i).data.Rct];
        cycle_times_Re_7 = [cycle_times_Re_7, cycle_7];
    end
end
% R_resistance_7 = Re_resistance_7 + Rct_resistance_7;
R_resistance_7 = Re_resistance_7
